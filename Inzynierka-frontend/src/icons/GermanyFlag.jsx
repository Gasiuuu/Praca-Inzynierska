function GermanyFlag({className}) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 55.2 38.4" className={className}>
            <g fill-rule="evenodd" clip-rule="evenodd">
                ...
                <path d="M0 12.8h55.2v22.57c0 1.67-1.36 3.03-3.03 3.03H3.03C1.36 38.4 0 37.04 0 35.37V12.8z"
                      fill="#d00"/>
